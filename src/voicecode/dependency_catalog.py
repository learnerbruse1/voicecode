...
DEPENDENCIES: tuple[DependencySpec, ...] = (
    ...
    DependencySpec(
        ...
        notes="This is a large dependency and requires a Hugging Face token for gated models.",
        estimated_install_mb=6000,
        restart_required=True,
    ),
    DependencySpec(
        id="nemo-toolkit",
        ...
        notes="This is a large dependency and downloads the configured model on first use.",
        estimated_install_mb=5000,
        restart_required=True,
    ),
)
